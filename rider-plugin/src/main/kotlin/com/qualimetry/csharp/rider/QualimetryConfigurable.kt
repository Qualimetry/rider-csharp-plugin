...
class QualimetryConfigurable : Configurable {
    ...
    private val autoProvisionField = JBCheckBox("Offer to add the analyzer when opening a C# solution")
    ...
    override fun createComponent(): JComponent {
        val built = FormBuilder.createFormBuilder()
            ...
            .addComponent(autoProvisionField, 1)
    ...
    override fun isModified(): Boolean {
        ...
        return urlField.text != s.sonarQubeUrl ||
            ...
            autoProvisionField.isSelected != s.autoProvision
    }
    ...
    override fun apply() {
        ...
        s.autoProvision = autoProvisionField.isSelected
    }
